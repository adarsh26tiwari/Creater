...
const PostPage = ({ params }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      {/* FIXED: added w-full overflow-hidden and responsive padding */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 w-full overflow-hidden">

        {/* FIXED: added w-full min-w-0 to prevent overflow */}
        <article className="space-y-8 w-full min-w-0">
          {/* Featured Image */}
          {post.featuredImage && (
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold gradient-text-primary break-words">
              {post.title}
            </h1>
          ...
          {/* FIXED: removed max-w-none, added break-words and overflow-hidden */}
          <div
            className="prose prose-lg prose-invert prose-purple w-full max-w-full overflow-wrap-anywhere"
